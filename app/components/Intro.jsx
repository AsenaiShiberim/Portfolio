export default function Intro() {
  return (
    <div className="flex items-center flex-col text-center pt-20 pb-6 px-4">
      <h1 className="text-2xl md:text-7xl mb-2 md:mb-4 font-bold">
        Asenai Shiberim
      </h1>
      <p className="text-base md:text-xl mb-4 font-medium text-gray-600 dark:text-gray-300">
        Software Developer
      </p>
      <p className="text-sm md:text-base max-w-3xl mb-6 font-medium text-gray-800 dark:text-gray-200">
